...
<Project Type="Project" LVVersion="15008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Decision Making Code" Type="Folder">
			<Item Name="Case Structure Tunnels.vi" Type="VI" URL="../Decision Making Code/Case Structure Tunnels.vi"/>
			<Item Name="Case Structure.vi" Type="VI" URL="../Decision Making Code/Case Structure.vi"/>
			<Item Name="Diagram Disable Structure.vi" Type="VI" URL="../Decision Making Code/Diagram Disable Structure.vi"/>
			<Item Name="Distance Conversion.vi" Type="VI" URL="../Decision Making Code/Distance Conversion.vi"/>
			<Item Name="Distance Unit.ctl" Type="VI" URL="../Decision Making Code/Distance Unit.ctl"/>
			<Item Name="Error Handling SubVI Example.vi" Type="VI" URL="../Decision Making Code/Error Handling SubVI Example.vi"/>
			<Item Name="Error Handling.vi" Type="VI" URL="../Decision Making Code/Error Handling.vi"/>
			<Item Name="Select Function.vi" Type="VI" URL="../Decision Making Code/Select Function.vi"/>
			<Item Name="Warning Numerics.vi" Type="VI" URL="../Decision Making Code/Warning Numerics.vi"/>
		</Item>
		<Item Name="Event Driven Code" Type="Folder">
			<Item Name="Creating an Event Structure.vi" Type="VI" URL="../Event Driven Code/Creating an Event Structure.vi"/>
			<Item Name="First Event Structure.vi" Type="VI" URL="../Event Driven Code/First Event Structure.vi"/>
			<Item Name="Notify and Filter Events.vi" Type="VI" URL="../Event Driven Code/Notify and Filter Events.vi"/>
			<Item Name="Polling Verse Event Driven Code.vi" Type="VI" URL="../Event Driven Code/Polling Verse Event Driven Code.vi"/>
		</Item>
		<Item Name="Event Driven State Machine" Type="Folder">
			<Item Name="Event Driven State Machine.aliases" Type="Document" URL="../Event Driven State Machine/Event Driven State Machine.aliases"/>
			<Item Name="Event Driven State Machine.lvlps" Type="Document" URL="../Event Driven State Machine/Event Driven State Machine.lvlps"/>
			<Item Name="Event Driven State Machine.lvproj" Type="Document" URL="../Event Driven State Machine/Event Driven State Machine.lvproj"/>
			<Item Name="States.ctl" Type="VI" URL="../Event Driven State Machine/States.ctl"/>
		</Item>
		<Item Name="Feedback" Type="Folder">
			<Item Name="Control System.vi" Type="VI" URL="../Feedback/Control System.vi"/>
			<Item Name="Shift Registers.vi" Type="VI" URL="../Feedback/Shift Registers.vi"/>
			<Item Name="Stacked Shift Registers.vi" Type="VI" URL="../Feedback/Stacked Shift Registers.vi"/>
			<Item Name="Uninitalized Shift Registers.vi" Type="VI" URL="../Feedback/Uninitalized Shift Registers.vi"/>
		</Item>
		<Item Name="For Loop" Type="Folder">
			<Item Name="Auto Indexing Array.vi" Type="VI" URL="../For Loop/Auto Indexing Array.vi"/>
			<Item Name="Concatenating Tunnels.vi" Type="VI" URL="../For Loop/Concatenating Tunnels.vi"/>
			<Item Name="Conditional Terminal.vi" Type="VI" URL="../For Loop/Conditional Terminal.vi"/>
			<Item Name="Employee Record - Type Def.ctl" Type="VI" URL="../For Loop/Employee Record - Type Def.ctl"/>
			<Item Name="Signal Generation.vi" Type="VI" URL="../For Loop/Signal Generation.vi"/>
			<Item Name="Title - Type Def.ctl" Type="VI" URL="../For Loop/Title - Type Def.ctl"/>
		</Item>
		<Item Name="While Loop" Type="Folder">
			<Item Name="Acquiring Data.vi" Type="VI" URL="../While Loop/Acquiring Data.vi"/>
			<Item Name="Analog Output.vi" Type="VI" URL="../While Loop/Analog Output.vi"/>
			<Item Name="Concatenate Output.vi" Type="VI" URL="../While Loop/Concatenate Output.vi"/>
			<Item Name="Conditional Tunnels.vi" Type="VI" URL="../While Loop/Conditional Tunnels.vi"/>
			<Item Name="Temperature Conversion.vi" Type="VI" URL="../While Loop/Temperature Conversion.vi"/>
			<Item Name="Timing Functions.vi" Type="VI" URL="../While Loop/Timing Functions.vi"/>
			<Item Name="While Loop.vi" Type="VI" URL="../While Loop/While Loop.vi"/>
		</Item>
